...
public Text icon_text_;
    ...
    private void Init()
    {
        switch (GSStatic.global_work_.system_language)
        {
            case SystemLanguage.Japanese:
                GSStatic.global_work_.language = "JAPAN";
                GSStatic.option_work.language_type = 0;
                break;
            case SystemLanguage.English:
                GSStatic.global_work_.language = "USA";
                GSStatic.option_work.language_type = 1;
                break;
            case SystemLanguage.French:
                GSStatic.global_work_.language = "FRANCE";
                GSStatic.option_work.language_type = 2;
                break;
            case SystemLanguage.German:
                GSStatic.global_work_.language = "GERMAN";
                GSStatic.option_work.language_type = 3;
                break;
            case SystemLanguage.Korean:
                GSStatic.global_work_.language = "KOREA";
                GSStatic.option_work.language_type = 4;
                break;
            case SystemLanguage.ChineseSimplified:
                GSStatic.global_work_.language = "CHINA_S";
                GSStatic.option_work.language_type = 5;
                break;
            case SystemLanguage.ChineseTraditional:
                GSStatic.global_work_.language = "CHINA_T";
        ...
        if (Language.languages.IndexOf(GSStatic.global_work_.language) > 6)
            AnimationIdentifier.instance.LoadDictionary(Application.dataPath + "/LangPacks/" + GSStatic.global_work_.language);
    ...
    private void inputTextSet()
    {
        ...
        string text = MessageSystem.EnToHalf(TextDataCtrl.GetText(in_text_id), "USA");
