...
public List<GuideIcon> guide_list_ = new List<GuideIcon>();
    ...
    protected virtual int GetLanguageTextFontSize(string language)
    {
        switch (language)
        {
            case "JAPAN":
            ...
            case "CHINA_T":
                return 22;
            default:
                return GetLanguageTextFontSize(Language.langFallback[language]);
        }
    }

    private TextAnchor GetLanguageTextAnchor(string language)
    {
        switch (language)
        {
            case "USA":
            ...
            default:
                return GetLanguageTextAnchor(Language.langFallback[language]);
        }
    }

    private float GetLanguageTextPositionY(string language)
    {
        switch (language)
        {
            case "USA":
            ...
            case "CHINA_T":
                return 0f;
            default:
                return GetLanguageTextPositionY(Language.langFallback[language]);
        }
    }
}
