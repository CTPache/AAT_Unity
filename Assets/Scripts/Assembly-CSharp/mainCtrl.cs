...
public class mainCtrl : MonoBehaviour
{
    ...
    [SerializeField]
public DebugMemory debug_memory_;
...
public Text text_;
    ...
    private IEnumerator SystemInitialization()
    {
        ...
        AssetBundleCtrl.instance.load("/menu/common/", "select_button", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "select_window", true, -1, true); ;
        AssetBundleCtrl.instance.load("/menu/option/", "option_count_bg01", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/option/", "option_button", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/option/", "option_gauge_bar", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "mask", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/title/", "title_text_back", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/title/", "def_title", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "writing", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "loading", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "save_window", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "save_data_slot", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "save_data_window", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "scrollbar", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "scrollbar_frame", true);
        AssetBundleCtrl.instance.load("/GS1/BG/", "bg043", true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "menu_bg", true, -1, true);
        string in_name = "symbol" + GSUtility.GetPlatformResourceName();
        AssetBundleCtrl.instance.load("/menu/common/", in_name, true, -1, true);
        AssetBundleCtrl.instance.load("/menu/common/", "symbol_xbox", true, -1, true);
