...
public class optionSe : optionItem
{
	[Serializable]
...
public OptionGauge gauge_;
	...
	public override void Init()
	{
		...
		SetText(TextDataCtrl.GetText(TextDataCtrl.OptionTextID.ITEM_SE));
		...
		setting_value_ = GSStatic.option_work.se_value;
	...
	public override void ChangeValue(int val)
	{
		...
		ValueSet();
		gaugeSpriteSet(2);
		instance.option_set_se_rate = 0.25f * (float)(setting_value_ - 1);
		if (flag)
		{
	...
	public override void OnTouch(TouchParameter touch_param)
	{
		...
		ValueSet();
		gaugeSpriteSet(2);
		soundCtrl.instance.option_set_se_rate = 0.25f * (float)(setting_value_ - 1);
	}

	private void ValueSet()
	{
		GSStatic.option_work.se_value = (ushort)setting_value_;
	...
	{
		soundCtrl.instance.option_set_se_rate = 0.25f * (float)(GSStatic.option_work.se_value - 1);
	}
