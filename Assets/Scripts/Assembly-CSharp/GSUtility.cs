...
public static class GSUtility
{
    ...
    public static string GetResourceNameLanguage(string language)
    {
        switch (Language.langFallback[language])
        {
            default:
                return string.Empty;
            case "USA":
    ...
    public static string GetLanguageLayoutType(string language)
    {
        switch (Language.langFallback[language])
        {
            case "JAPAN":
    ...
    public static int GetLanguageSlotNum(int slot_num, string language)
    {
        return slot_num + 10 * Language.languages.IndexOf(language);
    }

    public static string GetScenarioLanguage(string language)
    {
        return Language.getSufix(language);

    }

    public static DateTime DateTimeParse(string time, string language)
    {
