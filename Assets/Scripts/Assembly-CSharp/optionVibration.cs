...
public class optionVibration : optionItem
{
	[Serializable]
	...
	public override void Init()
	{
		...
		SetText(TextDataCtrl.GetText(TextDataCtrl.OptionTextID.ITEM_VIBRATION));
		...
		setting_value_ = GSStatic.option_work.vibe_type;
	...
	public override void ChangeValue(int val)
	{
		...
		if (setting_value_ == 0)
		{
			vibrationCtrl.instance.is_enable = false;
		}
		else
		{
			vibrationCtrl.instance.is_enable = true;
			vibrationCtrl.instance.play(20);
		}
		GSStatic.option_work.vibe_type = (ushort)setting_value_;
	}
	...
	public override void OnTouch(TouchParameter touch_param)
	{
		...
		if (num != setting_value_)
		{
			ChangeValue(num - setting_value_);
		}
	}
	...
	{
		if (GSStatic.option_work.vibe_type == 0)
		{
			vibrationCtrl.instance.is_enable = false;
		}
		else
