...
public class episodeReleaseCtrl : MonoBehaviour
{
	...
	[SerializeField]
	private List<StorySprite> story_list_;

	[SerializeField]
	private SpriteRenderer story_mask_;

	[SerializeField]
	private SpriteRenderer story_focus_L_;

	[SerializeField]
	private SpriteRenderer story_focus_R_;

	[SerializeField]
	private SpriteRenderer focus_L_;

	[SerializeField]
	private SpriteRenderer focus_R_;

	[SerializeField]
	private SpriteRenderer back_ground_;

	[SerializeField]
	private GameObject sprites_;
