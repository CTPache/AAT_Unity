...
public static class GSStatic
{
	...
	public static SaveData[] save_data = new SaveData[10];

	public static SaveData[] save_data_temp = new SaveData[100];
	...
	public static Language save_slot_language_ = Language.JAPAN;

	public static GameData[] game_data_temp_ = new GameData[100];
